...
if __name__ == '__main__':
    ...
    # for filename in os.listdir(Path(r"C:\Users\almogsh\PycharmProjects\Py_ChordAR\photos\working")):
    #     guitar = GuitarImage(img_path=Path(rf"C:\Users\almogsh\PycharmProjects\Py_ChordAR\photos\working\{filename}"),
    #                          file_name=filename)
